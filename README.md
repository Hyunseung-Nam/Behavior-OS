...
└── shared/
    ├── database/
    │   └── app_database.dart                    # Drift AppDatabase (ScheduleTable, v2)
    └── services/
...
- [ ] **Phase 5** — 알림 탭 딥링크 (`_onNotificationTapped` 구현)
- [ ] **Phase 6** — iOS BGTask 등록 (Info.plist BGTaskSchedulerPermittedIdentifiers)
